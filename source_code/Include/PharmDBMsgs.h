...
typedef struct
{
	...
	short					rx_origin;			// DonR 11Dec2024 User Story #373619.
}
...
TMsg2524Record;	// Table prescription_vouchers.
...
TMsg2525Record;	// Table pd_cannabis_products.
...
#define RECORD_LEN_2001											\
	(	Tpharmacy_code_len		+								\
		...
		1						+ /* Meishar Enabled		*/	\
		Tpharmacy_code_len		+ /* web_pharmacy_code		*/	\
		1						+ /* vat_exempt				*/	\
		2						+ /* software_house			*/	\
		1						+ /* order_originator		*/	\
		1						+ /* order_fulfiller		*/	\
		1						+ /* ConsignmentPharmacy - User Story #432608 */	\
		1						+ /* PharmNohalEnabled - User Story #432608	*/	\
		2						  /* mahoz - User Story #314887 */	\
	) /* end of record 2001 */
...
#define RECORD_LEN_2003				\
	...
	/* Marianna 04Aug2020 CR #28605	*/							\
	   ...
	   8						+	/* orig_confirm_num		*/	\
	/* Marianna 22Jan2023 User Story #276372*/					\
       1							/* exceptional_ishur	*/	\
	 )	/* end of rec 2003 */
...
#define RECORD_LEN_4005				\
     (Tlargo_code_len +				\
	  ...
	  1  /* v_print_generic_flg */	+	\
										\
	  /* DonR 14Oct2024 User Story #359136: Change from length 5 to 9. */ \
	  9  /* v_substitute_drug */	+	\
										\
	  20 /* package_volume */		+	\
	  2					/* copies_to_print */	+	\
	  ...
	  3					/* how_to_take_code	  */	+	\
	  3					/* unit_abbreviation  */	+	\
	  1					/* qualify_future_sales CR #30106 */					+	\
	  1					/* maccabi_profit_rating User Story #149963 */			+	\
	  8					/* 8 new 1-digit short flags - User Story #181694	*/	+	\
	  1					/* ConsignmentItem - User Story #432608 */				+	\
	  1					/* tikrat_piryon_pharm_type - User Story #376480 */		+	\
	  1					/* is_narcotic				- User Story #427521 */		+	\
	  1					/* psychotherapy_drug		- User Story #427521 */		+	\
	  1					/* preparation_type			- User Story #417800 */		+	\
	  6					/* chronic_days				- User Story #417800 */		+	\
	  1					/* two_pkg_size_levels		- User Story #450353  */	+	\
	140					/* 6 x qty & 2nd pkg volume	- User Story #450353  */	+	\
	 18					/* 6 x unit code			- User Story #450353  */		\
	) /* end of rec 2005/4005 */
...
#define RECORD_LEN_2030					\
     (Tlargo_code_len			+		\
	  ...
	  Tfixed_price_len	/* Yahalom Fixed Prc */	+	\
	  Twait_months_len	/* Wait Months */		+	\
	  1			/* pharm_real_time - Marianna 13Feb2023 User Story #417219 */ \
	  )  /* end of rec 2030 */
...
#define RECORD_LEN_2031				\
     (Tprice_list_code_len +		\
	  ...
	  Tsupplier_price_len  +		\
	  1					/*pharm_real_time - Marianna 13Feb2023 User Story #417219  */ \
	  ) /*20021111 Yulia*//* end of rec 2031 */
...
#define RECORD_LEN_2036												\
	(	Tmacabi_centers_num_len									+	\
		...
		Tcredit_flag_len										+	\
		Tallowed_proc_list_len									+	\
		Tallowed_belongings_len									+	\
		/* Marianna 22Jan2023 User Story #276011: changed type delivery_type from short to char(15)*/ \
		15							/* delivery_type 		*/	+	\
		9							/* sms_code				*/	+	\
		9							/* sms_format			*/	+	\
		9							/* sms_subformat		*/		\
...
#define RECORD_LEN_2049				\
    (	Tlargo_code_len		+		\
		...
		20	/* Per Qty.		*/		+	\
		3	/* Per Units	*/			\
	) /* end of rec 2049 DrugGenComponents */
...
#define RECORD_LEN_4068								\
	(	Tlargo_code_len							+	\
		...
		25 /* service_desc				*/		+	\
		 ...
		 1 /* Pvt. Pharm enabled		*/		+	\
		 1 /* OTC sale enabled			*/		+	\
		 4 /* Prev purchase class code	*/		+	\
		 5 /* Min prev purchases		*/		+	\
		 5 /* Max prev purchases		*/		+	\
		Tservice_type_len						)
...
#define RECORD_LEN_2076				\
   (6 +  /* v_sale_number        */	\
    9 +  /* v_largo_code Marianna 16Jul2024 User Story #330877  */	\
    9    /* v_sale_price         */	\
   )
...
#define RECORD_LEN_2082												\
	(	Tlargo_code_len			+									\
		...
		5						+	/* Rx src + Y/N, 3 + 2 */		\
		1						+	/* 28-day month 1/0 */			\
		3						+	/* # prev purchases needed */	\
		4						+	/* Custom error code */			\
		1						+	/* Incl. full-price sales */	\
		2						+	/* no_ishur_pharmacology */		\
		2							/* no_ishur_treat_typ */		\
	)
...
// DonR 02May2022 User Story #239501: Enlarged Max Age from 3 to 4 digits.
...
#define RECORD_LEN_4105	/* drug_shape */			\
	(	 4	/* drug_shape_code    */	+			\
		...
		25	/* shape_name_heb     */	+			\
		 ...
		 1	/* home_delivery_ok   */	+			\
		 1	/* calc_actual_usage  */	+			\
		 1	/* compute_duration	User Story #469361  */)	
...
// Marianna 23Sep2020 CR #32620
#define RECORD_LEN_4110	/* usage_instr_reason_changed */	\
	(	 3		/* reason_changed_code	*/	+				\
		30		/* reason_short_desc	*/	+				\
		50		/* reason_long_desc		*/						)

// DonR 17Oct2021 User Story #196891.
#define RECORD_LEN_4111	/* member_blocked_drugs	*/			\
	(	 9		/* member_id		*/		+				\
		 1		/* mem_id_extension	*/		+				\
		 9		/* largo_code		*/		+				\
		 2		/* restriction_type User Story 448931/458942*/	)	// DonR 13Mar2025 User Story #384811: Changed length from 1 to 2.
...
// DonR 30Mar2023 User Story #432608: Changed length of Total Drug Price and Total Member Price from 9 to 10.
// Also changed Times of Day from 40 to 100 characters, and added 8 new fields.
#define RECORD_LEN_2506							\
		(	Tpharmacy_code_len				+	\
			...
			1	/* IsConsignment	*/		+	\
			3	/* NumCourses		*/		+	\
			9	/* alternate_yarpa_price */	+	\
			8	/* blood_start_date	User Story #469361.*/		+	\
			5	/* blood_duration	User Story #469361.*/		+	\
			8	/* blood_last_date	User Story #469361.*/		+	\
			1	/* blood_data_calculated User Story #469361 */	+	\
			3	/* NumCannabisProducts */							\
	)
	/* end of record 2506 */
...
// pd_rx_link
// DonR 11Dec2024 User Story #373619: added rx_origin to upload.
...
// prescription_vouchers
#define RECORD_LEN_2524							\
	(	 9 /* prescription_id			*/ 	+	\
		11 /* voucher_num				*/	+	\
		 9 /* member_id					*/	+	\
		 1 /* mem_id_extension			*/	+	\
		15 /* voucher_type				*/	+	\
		 9 /* voucher_discount_given	*/	+	\
		 9 /* voucher_amount_remaining	*/	+	\
		 9 /* original_voucher_amount	*/	+	\
		 8 /* sold_date					*/		\
	)
	/* end of record 2524 */

// pd_cannabis_products
#define RECORD_LEN_2525							\
	(	 9 /* prescription_id			*/ 	+	\
		 2 /* line_no					*/	+	\
		 9 /* cannabis_product_code		*/	+	\
		13 /* cannabis_product_barcode	*/	+	\
		 9 /* group_largo_code			*/	+	\
		 5 /* op						*/	+	\
		 5 /* units						*/	+	\
		 9 /* price_per_op				*/	+	\
		 9 /* product_sale_amount		*/	+	\
		 9 /* product_ptn_amount		*/		\
	)
	/* end of record 2525 */
...
TMsgStruct MessageSequence[] =
{
	...
	{ 2030, RECORD_LEN_2030 },	// Drug_extension table
	...
	{ 4030, RECORD_LEN_2030 },	// Drug_extension table
	...
	{ 4048, RECORD_LEN_2048 },	// Marianna 24Jul2023 User Story #456129: GenComponents table.
	...
	{ 4071, RECORD_LEN_2071 },	// DonR 19Oct2020: Enable full-table usage_instruct download.
	{ 4074, RECORD_LEN_4074 },
	{ 4080, RECORD_LEN_2080 },	// Marianna 24Jul2023 User Story #456129: PharmDrugNotes table.
	...
	{ 4110, RECORD_LEN_4110 },	// Marianna CR #32620 23Sep2020: Full-table usage_instr_reason_changed download.
	{ 4111, RECORD_LEN_4111 },	// DonR 17Oct2021 User Story #196891: Full-table member_blocked_drugs download.
	{ 0L, 0L }					// terminating rec - changed from NULL 27Jun2005 for Linux compatibility.
} ;
