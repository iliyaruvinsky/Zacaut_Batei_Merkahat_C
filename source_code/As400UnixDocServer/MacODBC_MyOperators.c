...
//					break;
		...
		case AS400UDS_T3008_READ_hospital_member:
					SQL_CommandText		=	"	SELECT	entry_date,		discharge_date,		in_hospital,		"
											"			hospital_num,	hospital_name,		department_name,	"
											"			update_date,	update_time,		insertdate			"
											"	FROM	hospital_member				"
											"	WHERE	member_id			= ?		"
											"	  AND	mem_id_extension	= ?		";
					NumOutputColumns	=	9;
					OutputColumnSpec	=	"	int, int, short, int, char(25), char(30), int, int, int	";
					NumInputColumns		=	2;
		...
		case AS400UDS_T3008_INS_hospital_member:
					SQL_CommandText		=	"	INSERT INTO	hospital_member										"
											...
											"		update_time,		insertdate,			died_in_hospital	"
											"	)																";
					NumInputColumns		=	12;
					InputColumnSpec		=	"	int, short, int, int, short, int, char(25), char(30), int, int, int, short	";
					GenerateVALUES		=	1;
					break;
		...
		case AS400UDS_T3008_UPD_members:
					SQL_CommandText		=	"	UPDATE	members						"
											...
											"	  AND	mem_id_extension	= ?		";
					NumInputColumns		=	4;
					InputColumnSpec		=	"	short, short, int, short	";
					break;
