...
|---------|------|------:|------|
| main | ShrinkPharm.c | 35-359 (325 שורות) | נקודת כניסה - מתחבר ל-DB, קורא תצורת מחיקה, עובר על טבלאות יעד, מוחק שורות ישנות, מתעד סטטיסטיקות |
| TerminateHandler | ShrinkPharm.c | 370-430 (61 שורות) | מטפל אותות עבור SIGFPE, SIGSEGV, SIGTERM - מבצע rollback ורושם סיום ביומן |
