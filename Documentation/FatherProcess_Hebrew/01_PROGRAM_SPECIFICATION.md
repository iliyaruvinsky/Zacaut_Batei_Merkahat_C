...
|---------|------:|-------|------|
| main | 1323 | 146-1469 | נקודת כניסה, אתחול ולולאת שמירה |
| sql_dbparam_into_shm | 116 | 1481-1597 | טעינת פרמטרים ממסד הנתונים לזיכרון משותף |
| SqlGetParamsByName | 149 | 1608-1757 | קבלת פרמטרים ממסד הנתונים לפי שם תוכנית |
| run_system | 118 | 1766-1884 | הפעלת תהליכי בן מטבלת הפרמטרים |
| GetProgParm | 33 | 1893-1926 | חיפוש פרמטר בודד מהזיכרון המשותף |
| TerminateHandler | 35 | 1937-1972 | מטפל אותות עבור SIGTERM/SIGFPE/SIGSEGV |
| **סה"כ פונקציות** | **6** | | |
